                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li class="active"><a href="../pages/women.php">Women</a></li>
    ...
    <section class="shop spad">
        <div class="container">
            <div class="row">
                                    ...
                                    <div id="collapseTwo" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            ...
                                            <ul>
                                                ...
                                                $sql = "SELECT DISTINCT b.brandID, b.brandName 
                                                        FROM brand b 
                                                        INNER JOIN product p ON b.brandID = p.brandID 
                                                        INNER JOIN category c ON p.categoryID = c.categoryID 
                                                        WHERE c.categoryName = 'Women'"; 
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo '<li><a href="women.php?brandID=' . $row['brandID'] . '">' . htmlspecialchars($row['brandName']) . '</a></li>';
                                                    }
                                                } else {
                ...
                <div class="row">
                <?php
$whereClause = "WHERE c.categoryName='Women'"; 
...
//         JOIN product_variations pv ON p.productID = pv.productID $whereClause 
//         ORDER BY productPrice $sortOrder";
$sql = "SELECT p.*, pv.* 
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    sortSelect.addEventListener('change', function () {
        window.location.href = "women.php?sort=" + sortSelect.value; // Update URL
    });
});
</script>
