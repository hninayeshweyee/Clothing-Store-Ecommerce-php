                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li class="active"><a href="../pages/men.php">Men</a></li>
        ...
        <div class="container">
            <div class="row">
                                            ...
                                            <ul>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo '<li><a href="men.php?brandID=' . $row['brandID'] . '">' . htmlspecialchars($row['brandName']) . '</a></li>';
                                                    }
                                                } else {
                ...
                ?>
                    ...
                    <div class="row">
                            <?php
                            $whereClause = "WHERE c.categoryName='Men'"; 
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    sortSelect.addEventListener('change', function () {
        window.location.href = "men.php?sort=" + sortSelect.value; // Update URL
    });
});
</script>
