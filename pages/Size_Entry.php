...
if(!isset($_SESSION['staffID']))
    {
        ...
        echo "<script>window.location='sign-in.php'</script>";
            ...
            if(isset($_POST['btnSave']))
            {
              ...
              $select="SELECT * FROM size WHERE sizeName='$txtsizeName'";
              $run=mysqli_query($connect, $select);
              $count=mysqli_num_rows($run);
              if($count>0)
              {
                echo "<script>window.alert('Size Name is already register!')</script>";
              ...
              else
              {
                ...
                if($run)
                {
                  echo "<script>window.alert('Size Entry Successful')</script>";
                  echo "<script>window.location='Size_Entry.php'</script>";
                }
                else
                {
                  echo "<script>window.alert('Error In Size Entry')</script>";
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-warning" href="../pages/Size_Entry.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <form action="Size_Entry.php" method="POST">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="col-md-4">
        ...
        <div class="card-header pb-0 px-3">
              <h6 class="mb-0" style="padding-bottom: 15px">Size Entry</h6>
            </div>
        <div class="input-group input-group-outline mb-3">
            
                <input type="text" name="txtsizeName" class="form-control" placeholder="Enter your Size Name" style="background-color:white;" required>
        ...
        <div class="col-md-12 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Size Information</h6>
            </div>
            <div class="card-body pt-4 p-3">
              ...
              <?php
                    ...
                    if (isset($_POST['search-info'])) {
                      ...
                      $cquery = "select * from size where sizeName like '%$name%'";
                      ...
                      if ($crow == 0) {
                          ...
                          for ($i = 0; $i < $crow; $i++) {
                              ...
                              <span class='text-dark font-weight-bold ms-sm-2'>$sizeName</span>
                            </div>
                            <div class='ms-auto text-end'>
                    <a class='btn btn-link text-danger text-gradient px-3 mb-0' href='Size_Delete.php?sizeID=$sizeID'><i class='material-icons text-sm me-2'>delete</i>Delete</a>
                    <a class='btn btn-link text-dark px-3 mb-0' href='Size_Update.php?sizeID=$sizeID'><i class='material-icons text-sm me-2'>edit</i>Edit</a>
                  </div>
                      ...
                      $dquery = "select * from size order by sizeID DESC";
