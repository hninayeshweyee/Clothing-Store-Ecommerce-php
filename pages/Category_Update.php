...
if (isset($_POST['btnUpdate'])) {
	...
	$UpdateCategory="update category set categoryName = '$txtcategoryName' where categoryID = '$txtcategoryID'";

	$result = mysqli_query($connect,$UpdateCategory);

	if ($result) {
		// code...
		echo"<script>window.alert('Category Data Successfully Update!')</script>";
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card-header pb-0 px-3" style="padding-top: 0px;">
              <h6 class="mb-0" style="padding-bottom: 15px">Category Update</h6>
            </div>
        <div class="input-group input-group-outline mb-3">

                <input type="text" name="txtcategoryName" value="<?php echo $arr['categoryName']?>" class="form-control" style="background-color:white;" required>
