...
if (isset($_POST['btnUpdate'])) {
  ...
  if ($_FILES['txtcolorImage']['name']) {
      $filePhoto1 = $_FILES['txtcolorImage']['name'];
      $fileName1 = $folder . $filePhoto1;
      $copy1 = copy($_FILES['txtcolorImage']['tmp_name'], $fileName1);
	...
	$Updatecolor="update color set colorName = '$txtcolorName' ,image='$fileName1' where colorID = '$txtcolorID'";

	$result = mysqli_query($connect,$Updatecolor);
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        <div class="col-md-5">
            <form action="Color_Update.php" method="POST" enctype="multipart/form-data">
        <div class="card-header pb-0 px-3" style="padding-top: 0px;">
              <h6 class="mb-0" style="padding-bottom: 15px">Color Update</h6>
            </div>
        <div class="input-group input-group-outline mb-3">

                <input type="text" name="txtcolorName" value="<?php echo $arr['colorName']?>" class="form-control" style="background-color:white;" required>
                <div class="input-group input-group-outline mb-3">
                    <label>Image :</label>
                    <input type="file" name="txtcolorImage" accept="images/*" onchange="loadFile1(event)">
                ...
                <input type="hidden" name="txtcolorID" value="<?php echo $arr['colorID']?>">
                  </div>
