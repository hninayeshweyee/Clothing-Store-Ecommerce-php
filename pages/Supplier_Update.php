...
if (isset($_POST['btnUpdate'])) {
	...
	$UpdateSupplier="update supplier set supplierName = '$txtsupplierName',supplierAddress='$txtsupplierAddress',supplierEmail='$txtsupplierEmail',supplierPhone='$txtsupplierPhone',contactName='$txtsupplierContact' where supplierID = '$txtsupplierID'";

	$result = mysqli_query($connect,$UpdateSupplier);

	if ($result) {
		// code...
		echo"<script>window.alert('Supplier Data Successfully Update!')</script>";
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <!-- End Navbar -->
    <div class="container-fluid py-4" style="display: flex; justify-content: space-evenly;">
        <div class="col-md-5">
            <form action="Supplier_Update.php" method="POST">
        <div class="card-header pb-0 px-3" style="padding-top: 0px;">
              <h6 class="mb-0" style="padding-bottom: 15px">Supplier Update</h6>
        </div>
            <label class="form-label" class="font-weight-bolder mb-0">Supplier Name :</label>
            <div class="input-group input-group-outline mb-3">   
                <input type="text" name="txtsupplierName" class="form-control" value="<?php echo $arr['supplierName']?>" style="background-color:white;"required>
            </div>

            <label class="form-label" class="font-weight-bolder mb-0">Supplier Address :</label>
            <div class="input-group input-group-outline mb-3">
                <input type="text" name="txtsupplierAddress" class="form-control" value="<?php echo $arr['supplierAddress']?>" style="background-color:white;"required>
            </div>

            <label class="form-label" class="font-weight-bolder mb-0">Supplier Email :</label>
            <div class="input-group input-group-outline mb-3">
                <input type="text" name="txtsupplierEmail" class="form-control" value="<?php echo $arr['supplierEmail']?>" style="background-color:white;"required> 
            </div>
        ...
        <div class="card-header pb-0 px-3" style="padding-top: 0px;">
            ...
            <label class="form-label" class="font-weight-bolder mb-0">Phone Number :</label>
            <div class="input-group input-group-outline mb-3">
                <input type="text" name="txtsupplierPhone" class="form-control" value="<?php echo $arr['supplierPhone']?>" style="background-color:white;"required>
            </div>

            <label class="form-label" class="font-weight-bolder mb-0">Contact Name :</label>
            <div class="input-group input-group-outline mb-3">
                <input type="text" name="txtsupplierContact" class="form-control" value="<?php echo $arr['contactName']?>" style="background-color:white;"required>
            </div>
