...
if(isset($_POST['btnSave']))
{
    ...
    $txtsupplierContact = $_POST['txtsupplierContact'];

	$query="INSERT INTO supplier(supplierName,supplierAddress,supplierEmail,supplierPhone,contactName) Values ('$txtsuppliername','$txtsupplierAddress','$txtsupplierEmail','$txtsupplierPhone','$txtsupplierContact')";
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-warning" href="../pages/Supplier_Entry.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
    ...
    <div class="container-fluid py-4">
      ...
      <div class="col-md-5 mt-4">
        ...
        <div class="card-header pb-0 px-3">
              <h6 class="mb-0" style="padding-bottom: 15px">Supplier Entry</h6>
            </div>
            <div class="input-group input-group-outline mb-3">   
                <input type="text" name="txtsupplierName" class="form-control" placeholder="Enter Supplier Name" style="background-color:white;" required>
            </div>
            <div class="input-group input-group-outline mb-3">
                <input type="text" name="txtsupplierAddress" class="form-control" placeholder="Enter Supplier Address" style="background-color:white;" required>
            </div>
            <div class="input-group input-group-outline mb-3">
                <input type="email" name="txtsupplierEmail" class="form-control" placeholder="Enter Supplier Email" style="background-color:white;" required> 
            </div>
            <div class="input-group input-group-outline mb-3">
                <input type="number" name="txtsupplierPhone" class="form-control" placeholder="Enter Supplier Phone Number" style="background-color:white;" required>
            </div>
            <div class="input-group input-group-outline mb-3">
                <input type="text" name="txtsupplierContact" class="form-control" placeholder="Enter Contact Name" style="background-color:white;"required>
            </div>    
            ...
            <div class="card-body pt-4 p-3">
              ...
              <?php
                    ...
                    if (isset($_POST['search-info'])) {
                      ...
                      $cquery = "select * from supplier where supplierName like '%$name%'";
                      ...
                      if ($crow == 0) {
                          ...
                          for ($i = 0; $i < $crow; $i++) {
                              ...
                              $supplierID = $carr['supplierID'];
                              $supplierName = $carr['supplierName'];
                              $supplierAddress = $carr['supplierAddress'];
                              $supplierEmail = $carr['supplierEmail'];
                              $supplierPhone = $carr['supplierPhone'];
                              $supplierContact = $carr['contactName'];
                           
                              echo"<li class='list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg'>  
                              <div class='d-flex flex-column'>
                              <h6 class='mb-3 text-sm'>'$supplierName'</h6>
                              <span class='mb-2 text-xs'>Contact Name: <span class='text-dark font-weight-bold ms-sm-2'>$supplierContact</span></span>
                              <span class='mb-2 text-xs'>Supplier Address: <span class='text-dark font-weight-bold ms-sm-2'>$supplierAddress</span></span>
                              <span class='mb-2 text-xs'>Supplier Email: <span class='text-dark font-weight-bold ms-sm-2'>$supplierEmail</span></span>
                              <span class='mb-2 text-xs'>Phone Number: <span class='text-dark font-weight-bold ms-sm-2'>$supplierPhone</span></span>
                            </div>
                            <div class='ms-auto text-end'>
                    <a class='btn btn-link text-danger text-gradient px-3 mb-0' href='Supplier_Delete.php?supplierID=$supplierID'><i class='material-icons text-sm me-2'>delete</i>Delete</a>
                    <a class='btn btn-link text-dark px-3 mb-0' href='Supplier_Update.php?supplierID=$supplierID'><i class='material-icons text-sm me-2'>edit</i>Edit</a>
                  </div>
                      ...
                      $dquery = "select * from supplier order by supplierID DESC";
                      ...
                      if ($count == 0) {
                          ...
                          for ($i = 0; $i < $count; $i++) {
                              ...
                              $supplierID = $darr['supplierID'];
                              $supplierName = $darr['supplierName'];
                              $supplierAddress = $darr['supplierAddress'];
                              $supplierEmail = $darr['supplierEmail'];
                              $supplierPhone = $darr['supplierPhone'];
                              $supplierContact = $darr['contactName'];
