...
if(isset($_POST['btnSearch'])) 
{
	...
	elseif($rdoSearchType == 2) 
	{
		...
		$query="SELECT po.*, s.customerID,s.customerName 
				FROM orders po, customer s
				WHERE po.orderDate BETWEEN '$txtFrom' AND '$txtTo'
				AND po.customerID=s.customerID
				ORDER BY po.orderID DESC"; 
		$result=mysqli_query($connect,$query);
		$count=mysqli_num_rows($result);
...
else if(isset($_POST['btnShowAll'])) 
{
	$query="SELECT po.*, s.customerID,s.customerName 
			FROM orders po, customer s
			WHERE po.customerID=s.customerID
			ORDER BY po.orderID DESC"; 
	$result=mysqli_query($connect,$query);
	$count=mysqli_num_rows($result);
       // Calculate the total amount
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-warning " href="../pages/Order_List.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Customer Order List</li>
    ...
    <!-- End Navbar -->
        ...
        <form action="Order_List.php" method="post">
            ...
            <tr>
            	...
            	<input type="radio" name="rdoSearchType" value="1" checked/>Search By Order_ID
            ...
            if($count<1) 
            {
            	echo "<p>No Customer Order Found.</p>";
            }
            else
            {
            ?>
            	...
            	{ 
            		...
            		echo "<td class='text-xs font-weight-bold mb-0 align-middle text-center text-sm'><a href='Order_Detail.php?orderID=$Purchase_ID'>Details</a></td>";
            		echo "</tr>";
            	}			
            	 ?>
            	</table>
