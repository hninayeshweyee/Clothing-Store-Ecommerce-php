...
if(!isset($_SESSION['staffID']))
    {
        ...
        echo "<script>window.location='sign-in.php'</script>";
            ...
            if(isset($_POST['btnSave']))
            {
              ...
              $select="SELECT * FROM brand WHERE brandName='$txtbrandName'";
              $run=mysqli_query($connect, $select);
              $count=mysqli_num_rows($run);
              if($count>0)
              {
                echo "<script>window.alert('Brand Name is already register!')</script>";
              ...
              else
              {
                ...
                if($run)
                {
                  echo "<script>window.alert('Brand Entry Successful')</script>";
                  echo "<script>window.location='Brand_Entry.php'</script>";
                }
                else
                {
                  echo "<script>window.alert('Error In Brand Entry')</script>";
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb" style="width:100%">
          ...
          <h6 class="font-weight-bolder mb-0">Manage Brand</h6>
        </nav>
        <form action="Brand_Entry.php" method="POST">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="col-md-5 mt-4">
        ...
        <div class="card-header pb-0 px-3">
              <h6 class="mb-0" style="padding-bottom: 15px">Brand Entry</h6>
            </div>
        <div class="input-group input-group-outline mb-3">
            
                <input type="text" name="txtbrandName" class="form-control" placeholder="Enter your BrandName" style="background-color:white;" required>
                  </div>
            ...
            <div class="card-body pt-4 p-3">
              ...
              <?php
                    ...
                    if (isset($_POST['search-info'])) {
                      ...
                      $cquery = "select * from brand where brandName like '%$name%'";
                      ...
                      if ($crow == 0) {
                          ...
                          for ($i = 0; $i < $crow; $i++) {
                              ...
                              $brandID = $carr['brandID'];
                              $brandName = $carr['brandName'];
                              ...
                              <span class='text-dark font-weight-bold ms-sm-2'>$brandName</span>
                            </div>
                            <div class='ms-auto text-end'>
                    <a class='btn btn-link text-danger text-gradient px-3 mb-0' href='Brand_Delete.php?brandID=$brandID'><i class='material-icons text-sm me-2'>delete</i>Delete</a>
                    <a class='btn btn-link text-dark px-3 mb-0' href='Brand_Update.php?brandID=$brandID'><i class='material-icons text-sm me-2'>edit</i>Edit</a>
                  </div>
                      ...
                      $dquery = "select * from brand order by brandID DESC";
                      ...
                      if ($count == 0) {
                          ...
                          for ($i = 0; $i < $count; $i++) {
                              ...
                              $brandID = $darr['brandID'];
                              $brandName = $darr['brandName'];
