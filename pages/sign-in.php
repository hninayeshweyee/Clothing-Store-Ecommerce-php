...
if (isset($_POST['btnLogin'])) {
    ...
    if ($count > 0) {
        ...
        $ID = $arr['staffID']; // Database column name
        $Name = $arr['staffName'];
...
<body class="bg-gray-200">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('../images/admin_sign_in_bg.jpg');">
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class=" shadow-primary border-radius-lg py-3 pe-1" style="background-color: #FFBD61;">
                  <h4 class=" font-weight-bolder text-center mt-2 mb-0" style="color: black;">Admin Login</h4>
                 
                </div>
              </div>
              <div class="card-body">
                <form role="form" action="sign-in.php" method="POST" enctype="multipart/form-data">

                <!-- <label class="form-label" style="color: black;">Email</label> -->
                  <div class="input-group input-group-outline my-3" >
                    <input type="email" name="txtEmail" class="form-control" placeholder="Enter your email" style="color: black;">
                  </div>
                  ...
                  <div class="text-center">
                    <input type="submit" name="btnLogin" value="Login" class="btn w-100 my-4 mb-2" style="background-color: #FFBD61; color: black;">  
