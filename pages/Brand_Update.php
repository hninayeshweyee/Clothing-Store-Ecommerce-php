...
if (isset($_POST['btnUpdate'])) {
	...
	$UpdateBrand="update brand set brandName = '$txtbrandName' where brandID = '$txtbrandID'";

	$result = mysqli_query($connect,$UpdateBrand);

	if ($result) {
		// code...
		echo"<script>window.alert('Brand Data Successfully Update!')</script>";
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card-header pb-0 px-3" style="padding-top: 0px;">
              <h6 class="mb-0" style="padding-bottom: 15px">Brand Update</h6>
            </div>
        <div class="input-group input-group-outline mb-3">

                <input type="text" name="txtbrandName" value="<?php echo $arr['brandName']?>" class="form-control" style="background-color:white;" required>
                <input type="hidden" name="txtbrandID" value="<?php echo $arr['brandID']?>">
                  </div>
